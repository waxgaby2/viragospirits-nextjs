...
function VisionGuiResult(t0) {
  ...
  let t23;
  $[61] !== t21 || $[62] !== t22 ? (t23 = /* @__PURE__ */ jsxs(ResultFooter, { justify: "space-between", direction: t14, children: [
    t21,
    t22
  ] }), $[61] = t21, $[62] = t22, $[63] = t23) : t23 = $[63];
  let t24;
  return $[64] !== t13 || $[65] !== t23 ? (t24 = /* @__PURE__ */ jsxs(ResultOuterContainer, { direction: "column", "data-testid": "vision-result", children: [
    t13,
    t23
...
function useDatasets(t0) {
  ...
  bb0: {
    ...
    if ($[2] !== client.observable.datasets || $[3] !== configDatasets) {
      let t3;
      $[5] !== configDatasets ? (t3 = (result) => typeof configDatasets == "function" ? configDatasets(result).map(_temp) : result.map(_temp2), $[5] = configDatasets, $[6] = t3) : t3 = $[6], t2 = client.observable.datasets.list().pipe(map$1(t3), catchError(_temp3)), $[2] = client.observable.datasets, $[3] = configDatasets, $[4] = t2;
    } else
      t2 = $[4];
    t1 = t2;
  }
